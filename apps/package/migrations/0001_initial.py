...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('package_category', (
            ...
            ('show_pypi', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        ...
        db.create_table('package_package', (
            ...
            ('repo_url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=200, blank=True)),
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='creator', null=True, to=orm['auth.User'])),
            ('last_modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modifier', null=True, to=orm['auth.User'])),
            ('pypi_home_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
